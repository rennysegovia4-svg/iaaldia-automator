...
_forced_persona = os.environ.get("FORCE_PERSONA", "").strip()
_PERSONA_KEY   = _forced_persona if _forced_persona in NARRATOR_PERSONAS else _PERSONA_KEYS[_day_num % len(_PERSONA_KEYS)]
